...
public class Cursist {
    ...
    public Cursist(int id, String emailAdres, String naam, LocalDate geboortedatum, Geslacht geslacht, String straat,
            String huisnr, String postcode, String woonplaats, String land) {
        this.id = id;
