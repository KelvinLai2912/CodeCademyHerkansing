...
import codecademyher.domain.Status;
...
/**
 * ModuleDB beheert de informatie uit de database voor gegevens uit de 'Module'
 * tabel.
 */
public class ModuleDB {

    // Maakt voor elke record in de 'Module' tabel een module en retourneert deze in
    // een ArrayList
    ...
    // Retourneert alle modules die niet aan een cursus gekoppeld zijn in een
    // ArrayList.
    ...
    // Retourneert alle modules die aan een bepaalde cursus gekoppeld zijn in een
    // ArrayList.
    ...
    // Wijzigt 'CursusID' in de database van een bepaalde module naar een het
    // cursusid in de parameters.
