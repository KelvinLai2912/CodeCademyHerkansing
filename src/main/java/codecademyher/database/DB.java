...
public class DB {
    ...
    // Voert de parameter uit als query in de database, en retourneert het resultaat
    // daarvan als ResultSet.
    ...
    // Voert de parameter uit als query in de database, en retourneert of de query
    // succesvol was of niet als boolean.
